...
| `scripts/setup_kuma.sh` | NUEVO: Verificar Uptime Kuma | Diagnóstico de monitor |
| `scripts/validate.sh` | NUEVO: Validación completa | Post-despliegue |
...
### Seguridad
- ADVERTENCIA: Las credenciales por defecto son SOLO PARA DEMOSTRACIÓN
- ADVERTENCIA: Cambiar todas las contraseñas en entorno de producción
...
- NUEVO: Validación post-despliegue
- NUEVO: Verificación de Uptime Kuma
