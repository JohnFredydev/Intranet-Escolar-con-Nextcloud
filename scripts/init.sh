...
show_summary() {
  ...
  echo -e "    Usuario:    ${CYAN}${NEXTCLOUD_ADMIN_USER:-admin}${NC}"
  echo -e "    Contraseña: ${CYAN}${NEXTCLOUD_ADMIN_PASSWORD:-Admin#2025!Cole}${NC}"
  echo ""
  echo -e "  ${BOLD}Profesor:${NC}"
  echo -e "    Usuario:    ${CYAN}profe${NC}"
  echo -e "    Contraseña: ${CYAN}Profe#2025!Abc${NC}"
  echo ""
  echo -e "  ${BOLD}Alumnos:${NC}"
  echo -e "    Usuario:    ${CYAN}alumno1${NC} / ${CYAN}alumno2${NC}"
  echo -e "    Contraseña: ${CYAN}Alu1#2025!Abc${NC} / ${CYAN}Alu2#2025!Abc${NC}"
  echo ""
  
  log_info "Próximos pasos:"
  echo -e "  1. Accede a Nextcloud en ${CYAN}http://localhost:8080${NC}"
  echo "  2. Explora las carpetas compartidas (Group Folders)"
  echo -e "  3. Configura Uptime Kuma en ${CYAN}http://localhost:3001${NC}"
  echo -e "  4. Revisa las evidencias en ${CYAN}docs/logs/${NC}"
  echo ""
  ...
  echo -e "  ${CYAN}bash scripts/backup.sh${NC}               # Crear backup"
